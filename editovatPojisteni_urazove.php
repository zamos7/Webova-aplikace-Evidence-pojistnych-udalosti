...
if($_SERVER['REQUEST_METHOD'] == "GET")
{
    ...
    $pojisteni_urazove = $row['jmeno'];
}
else
{
    $pojisteni_urazove = $_POST['pojisteni_urazove'];

        $sql = "UPDATE pojisteni SET pojisteni_urazove = '$pojisteni_urazove' WHERE id=$id";
    ...
    <body>
        ...
        <h1><?php echo  $jmeno . " " . $prijmeni;?></h1>
            ...
            <input type="hidden" name="id" value="<?php echo $id;?>">  
                <div id="form2" >
                    <a>Úrazové pojištění<input id="text" type="number" name="pojisteni_urazove" value=<?php echo $pojisteni_urazove;?>></a><br><br>

    ...
    if($_SERVER['REQUEST_METHOD'] == "GET")
{
    ...
    $pojisteni_cestovni = $row['jmeno'];
}
else
{
    $pojisteni_cestovni = $_POST['pojisteni_cestovni'];

        $sql = "UPDATE pojisteni SET pojisteni_cestovni = '$pojisteni_cestovni' WHERE id=$id";
    ...
    <body>
        ...
        <h1><?php echo  $jmeno . " " . $prijmeni;?></h1>
            ...
            <input type="hidden" name="id" value="<?php echo $id;?>">  
                <div id="form2" >
                    <a>Cestovní pojištění<input id="text" type="number" name="pojisteni_cestovni" value=<?php echo $pojisteni_cestovni;?>></a><br><br>

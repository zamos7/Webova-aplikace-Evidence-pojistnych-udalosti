...
if($_SERVER['REQUEST_METHOD'] == "GET")
{
    ...
    $pojisteni_zivotni = $row['jmeno'];
}
else
{
    $pojisteni_zivotni = $_POST['pojisteni_zivotni'];

        $sql = "UPDATE pojisteni SET pojisteni_zivotni = '$pojisteni_zivotni' WHERE id=$id";
    ...
    <body>
        ...
        <h1><?php echo  $jmeno . " " . $prijmeni;?></h1>
            ...
            <input type="hidden" name="id" value="<?php echo $id;?>">  
                <div id="form2" >
                    <a>Životní pojištění<input id="text" type="number" name="pojisteni_zivotni" value=<?php echo $pojisteni_zivotni;?>></a><br><br>
